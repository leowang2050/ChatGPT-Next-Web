...
const cn = {
  ...
  Error: {
    Unauthorized:
      "您未设置APIKEY，关注公众号：[AI迈森](https://daili.chatgpt365.life/)，回复  apikey  ，将免费获取一个APIKEY，然后点击左下角[设置](/#/settings)页输入API-key即可正常对话，也可在本站[购买](https://daili.chatgpt365.life/) API KEY或者填入您自有的 OpenAI API Key",
  },
  ChatItem: {
